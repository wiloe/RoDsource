...
/*  {   command		function	}, */
    ...
    {   "v4",		oedit_value4	},  /* ROM */
    {   "weight",	oedit_weight	},
    {	"furniture",	oedit_furniture }, /*Kat 04161999*/
    ...
    {   "locationstring", oedit_loc_str },  /* Akira */
    {	"autoobj",	oedit_autoobj	},
...
void redit( CHAR_DATA *ch, char *argument )
{
    ...
    sprintf( buf, "%s editing room %d", ch->name, pRoom->vnum );
    log_string( buf ); 
